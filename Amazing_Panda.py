...
def initialize_voxels():
    ...
    make(elli,10.3,25.8,6.9,0.0,0.0,0.0,vec3(-26,-42,-11),vec3(-0.9,-0.1,-0.4),vec3(-0.0,1.0,-0.2),rgb(14,14,14),1,0)
    make(elli,2.6,3.5,2.6,0.0,0.0,0.0,vec3(-45,-32,-26),vec3(0.0,1.0,0.2),vec3(0.8,-0.1,0.6),rgb(14,14,14),1,0)
    make(elli,7.6,14.6,7.6,0.0,0.0,0.0,vec3(-45,-41,-25),vec3(-0.9,0.3,-0.4),vec3(0.3,0.9,0.1),rgb(14,14,14),1,0)
    make(elli,8.3,17.1,8.1,0.0,0.0,0.0,vec3(-14,-20,10),vec3(0.8,-0.4,-0.5),vec3(-0.5,0.1,-0.8),rgb(14,14,14),1,0)
    make(elli,8.3,17.1,8.1,0.0,0.0,0.0,vec3(6,-21,26),vec3(0.8,-0.4,-0.5),vec3(-0.5,0.1,-0.8),rgb(14,14,14),1,0)
    make(elli,1.0,1.0,13.7,0.0,0.0,0.0,vec3(-2,-5,28),vec3(0.6,-0.1,-0.8),vec3(0.4,0.9,0.1),rgb(14,14,14),1,0)
    make(elli,1.0,1.0,13.7,0.0,0.0,0.0,vec3(-18,-5,17),vec3(0.7,-0.5,-0.5),vec3(-0.3,-0.8,0.5),rgb(14,14,14),1,0)
    make(elli,7.1,3.2,5.7,0.0,0.0,0.0,vec3(-30,-26,5),vec3(0.8,-0.4,-0.5),vec3(-0.5,0.1,-0.8),rgb(204,82,131),1,0)
    make(elli,3.5,1.0,2.9,0.0,0.0,0.0,vec3(2,-32,39),vec3(0.2,0.2,-1.0),vec3(-0.3,0.9,0.2),rgb(204,82,131),1,0)
    make(elli,5.0,9.5,13.4,0.0,0.0,0.0,vec3(-15,-33,27),vec3(0.1,1.0,-0.1),vec3(-0.5,0.1,0.9),rgb(0,0,0),1,0)
initialize_voxels()
scene.finish()
